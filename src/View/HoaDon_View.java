...
public class HoaDon_View extends javax.swing.JFrame {
    ...
    private boolean CheckNam(String nam){
        for (int i = 0; i <cbxNam.getItemCount();i++ ){
            if(cbxNam.getItemAt(i).equals(nam)){
                return false;
            }
        }
        return true;
    ...
    private int KiemTraGiaTriChonMacDinh(){
        /*
            Ket qua cua phep kiem tra chon nhu sau
            Ngay Thang Nam = 111 = 111
            Ngay Thang     = 110 = 110
            Ngay           = 100 = 100
                 Thang Nam = 011 = 11
                 Thang     = 010 = 10
        ...
        */
        ...
        if(cbxThang.getSelectedIndex() == 0){
            temp += "0";
        }
        else{
            temp += "1";
    ...
    private void LocNgayLap(){
        switch(KiemTraGiaTriChonMacDinh()){
            case 111:{
                int nam = Integer.parseInt((String) cbxNam.getSelectedItem());
                int thang = Integer.parseInt((String) cbxThang.getSelectedItem());
                int ngay = Integer.parseInt((String) cbxNgay.getSelectedItem());
                LocalDate currentDate;
                model.setRowCount(0);
                for (HoaDon s : list){
                    currentDate = LocalDate.parse(s.getNgayLap().toString());
                    if(currentDate.getYear() == nam && currentDate.getMonthValue()== thang && currentDate.getDayOfMonth() == ngay){
                        model.addRow(new Object[]{
                                s.getMaHD(),s.getMaNV(),s.getMaKH(),s.getNgayLap(),s.getThongTinUuDai(),currencyVN.format(s.getTongTien())
                            });
                    }
            ...
            case 110:{
                ...
                for (HoaDon s : list){
                    currentDate = LocalDate.parse(s.getNgayLap().toString());
                    if(currentDate.getMonthValue()== thang && currentDate.getDayOfMonth() == ngay){
                        model.addRow(new Object[]{
                                s.getMaHD(),s.getMaNV(),s.getMaKH(),s.getNgayLap(),s.getThongTinUuDai(),currencyVN.format(s.getTongTien())
                            });
                    }
            ...
            case 100:{
                ...
                for (HoaDon s : list){
                    currentDate = LocalDate.parse(s.getNgayLap().toString());
                    if(currentDate.getDayOfMonth() == ngay){
                        model.addRow(new Object[]{
                                s.getMaHD(),s.getMaNV(),s.getMaKH(),s.getNgayLap(),s.getThongTinUuDai(),currencyVN.format(s.getTongTien())
                            });
                    }
            ...
            case 11:{
                ...
                for (HoaDon s : list){
                    currentDate = LocalDate.parse(s.getNgayLap().toString());
                    if(currentDate.getYear() == nam && currentDate.getMonthValue()== thang){
                        model.addRow(new Object[]{
                                s.getMaHD(),s.getMaNV(),s.getMaKH(),s.getNgayLap(),s.getThongTinUuDai(),currencyVN.format(s.getTongTien())
                            });
                    }
            ...
            case 10:{
                ...
                for (HoaDon s : list){
                    currentDate = LocalDate.parse(s.getNgayLap().toString());
                    if( currentDate.getMonthValue()== thang){
                        model.addRow(new Object[]{
                                s.getMaHD(),s.getMaNV(),s.getMaKH(),s.getNgayLap(),s.getThongTinUuDai(),currencyVN.format(s.getTongTien())
                            });
                    }
            ...
            case 101:{
                ...
                for (HoaDon s : list){
                    currentDate = LocalDate.parse(s.getNgayLap().toString());
                    if(currentDate.getYear() == nam && currentDate.getDayOfMonth() == ngay){
                        model.addRow(new Object[]{
                                s.getMaHD(),s.getMaNV(),s.getMaKH(),s.getNgayLap(),s.getThongTinUuDai(),currencyVN.format(s.getTongTien())
                            });
                    }
    ...
    private boolean NamNhuan(){
        int nam;
        try{
            nam = Integer.parseInt(cbxNam.getSelectedItem().toString());
        }
    ...
    private javax.swing.JLabel BookStore1;
    private javax.swing.JLabel BookStore2;
    private javax.swing.JLabel BookStore3;
    private javax.swing.JLabel BookStore4;
    private javax.swing.JPanel ThanhMenu;
    private javax.swing.JPanel ThanhMenu1;
    private javax.swing.JPanel ThanhMenu2;
    private javax.swing.JPanel ThanhMenu3;
    ...
    private javax.swing.JLabel lbBanSach1;
    private javax.swing.JLabel lbBanSach2;
    private javax.swing.JLabel lbBanSach3;
    private javax.swing.JLabel lbBanSach4;
    private javax.swing.JLabel lbNhaCungCap1;
    private javax.swing.JLabel lbNhaCungCap2;
    private javax.swing.JLabel lbNhaCungCap3;
    private javax.swing.JLabel lbNhaCungCap4;
    ...
    private javax.swing.JLabel lbNhapSach1;
    private javax.swing.JLabel lbNhapSach2;
    private javax.swing.JLabel lbNhapSach3;
    ...
    private javax.swing.JLabel lbPhieu4;
    private javax.swing.JLabel lbPhieu5;
    private javax.swing.JLabel lbPhieu6;
    private javax.swing.JLabel lbPhieu7;
    private javax.swing.JLabel lbPhieu8;
    private javax.swing.JLabel lbPhieu9;
