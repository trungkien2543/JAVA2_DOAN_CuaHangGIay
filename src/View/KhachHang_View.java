...
public class KhachHang_View extends javax.swing.JFrame {
    ...
    private ArrayList<KhachHang> timKiem(String value, int selected) {
     ...
     private void sapXep(ArrayList<KhachHang> rs, int selected) {
        ArrayList<KhachHang> tmp = new ArrayList<>(rs);
        switch (selected) {
            case 0:
                break;
            case 1:
...
//                 giam dan      
    ...
    private void txtFindKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFindKeyReleased
        ...
        ArrayList<KhachHang> rs = timKiem(value, selectDK);
        sapXep(rs, selectSX);
